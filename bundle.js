(function (xeokitSdk_es_min_js, AnnotationsPlugin_js) {
  ...
  new xeokitSdk_es_min_js.XKTLoaderPlugin(viewer);

  new xeokitSdk_es_min_js.NavCubePlugin(viewer, {
  ...
  const webIFCLoader = new xeokitSdk_es_min_js.WebIFCLoaderPlugin(viewer, {
  ...
  const sectionPlanes = new xeokitSdk_es_min_js.SectionPlanesPlugin(viewer, {
      ...
      if (createSectionPlaneMode) {
          ...
          if (pickResult && pickResult.worldNormal) { // Disallow SectionPlanes on point clouds, because points don't have normals
              const sectionPlane = sectionPlanes.createSectionPlane({
                  ...
                  dir: xeokitSdk_es_min_js.math.mulVec3Scalar(pickResult.worldNormal, -1)
              });
  ...
  const distanceMeasurements = new xeokitSdk_es_min_js.DistanceMeasurementsPlugin(viewer, {});
  let measureDistanceMode = false;
  let measurementsCleared = false;

  const distanceMeasurementsContextMenu = new xeokitSdk_es_min_js.ContextMenu({
    items: [
      [
        {
          title: "Clear",
  ...
  new xeokitSdk_es_min_js.ContextMenu({
    enabled: true,
    context: {
      viewer: viewer,
    },
  ...
  new xeokitSdk_es_min_js.TreeViewPlugin(viewer, {
  ...
  viewer.scene.input.on("mouseclicked", (coords) => {
    ...
    if (pickResult) {
      ...
      const entityCenter = xeokitSdk_es_min_js.math.getAABB3Center(aabb);
  ...
  const distm = new xeokitSdk_es_min_js.DistanceMeasurementsPlugin(viewer, {
